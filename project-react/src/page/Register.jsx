...
const Register = () => {
  return (
    <main class="flex flex-1 items-center justify-center p-6 bg-gradient-to-b from-blue-100 via-white to-blue-100 dark:from-navy-900 dark:via-background-dark dark:to-navy-900">
