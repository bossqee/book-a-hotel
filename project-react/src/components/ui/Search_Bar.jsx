  ...
  return (
    <div class="w-full max-w-4xl bg-white/95 dark:bg-background-dark/95 backdrop-blur-md p-2 rounded-xl shadow-2xl flex flex-col md:flex-row items-stretch gap-2 border border-white/20">
      <div class="flex-1 flex items-center px-4 py-3 border-r border-gray-100 dark:border-gray-800">
        ...
        <input
          class="bg-transparent border-none focus:ring-0 text-deep-navy dark:text-black placeholder:text-gray-400 w-full font-medium text-black"
      ...
      <div class="flex-1 flex items-center px-4 py-3 border-r border-gray-100 dark:border-gray-800">
        ...
        <input
          class="bg-transparent border-none focus:ring-0 text-deep-navy dark:text-black text-black placeholder:text-gray-400 w-full font-medium"
